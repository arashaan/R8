...
namespace R8.Lib.AspNetCore.EntityFrameworkCore
{
    ...
    /// </summary>
    public partial class DbContextBase : R8.Lib.EntityFrameworkCore.DbContextBase
    {
        public IHttpContextAccessor HttpContextAccessor { get; set; }

        protected DbContextBase() : this(new DbContextOptions<R8.Lib.EntityFrameworkCore.DbContextBase>())
        {
        }
